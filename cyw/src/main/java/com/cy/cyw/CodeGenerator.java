...
//        gc.setSwagger2(true); //实体属性 Swagger2 注解
        ...
        dsc.setUrl(codeGenerator.url);
        // dsc.setSchemaName("public");
        dsc.setDriverName(codeGenerator.driverClassName);
        dsc.setUsername(codeGenerator.username);
        dsc.setPassword(codeGenerator.password);
